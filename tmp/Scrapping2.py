...
dish_order_categories = ["Kategoria:Lehen platerak",
                         "Kategoria:Bigarren platerak", 
                         "Kategoria:Azkenburukoak"]
order_dict = scrap_recipes_by_category_list(url, base_url,dish_order_categories)

# VISUALIZE RESULT
for key in order_dict.keys():
    print("\n\n",key)
    for recipe in order_dict.get(key):
        print("- ", recipe)
